/**
 * file: mpi_ring_fix_nonblocking.c
 * demonstrates the occurence of deadlock in a ring communication

Compile with:
gcc -g mpi_ring_fix_nonblocking.c -I "c:\Program Files (x86)\Microsoft SDKs\MPI\Include" -L "c:\Program Files (x86)\Microsoft SDKs\MPI\Lib\x64" -lmsmpi -o mpi_ring_fix_nonblocking.exe
